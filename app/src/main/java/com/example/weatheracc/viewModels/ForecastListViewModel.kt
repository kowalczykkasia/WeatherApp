...
class ForecastListViewModel @Inject constructor(private val repository: Repository,
    ...
    fun deleteCity(weatherForecast: WeatherForecast){
        viewModelScope.launch {
            repository.deleteCity(weatherForecast)
        }
    }
